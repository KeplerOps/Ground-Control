...
- ADR-011: Requirements data model — documents UUID PKs, DAG relations, AGE-as-query-layer strategy, no new library dependencies
- Phase 1 design notes (`architecture/notes/phase1-requirements-design.md`) with data model, app structure, and key patterns

...
public class GitHubIssueSweepNotifier implements SweepNotifier {
    ...
    static String formatBody(SweepReport report) {
        ...
        appendCycles(sb, report);
        appendOrphans(sb, report);
        appendCoverageGaps(sb, report);
        appendCrossWaveViolations(sb, report);
        appendConsistencyViolations(sb, report);
        appendStatusDrift(sb, report);

        sb.append("---\n*Generated by Ground Control analysis sweep*");
        return sb.toString();
    }

    private static void appendCycles(StringBuilder sb, SweepReport report) {
    ...
    private static void appendOrphans(StringBuilder sb, SweepReport report) {
    ...
    private static void appendCoverageGaps(StringBuilder sb, SweepReport report) {
    ...
    private static void appendCrossWaveViolations(StringBuilder sb, SweepReport report) {
    ...
    private static void appendConsistencyViolations(StringBuilder sb, SweepReport report) {
    ...
    private static void appendStatusDrift(StringBuilder sb, SweepReport report) {
        ...
        for (StatusDriftResult.Finding f : report.statusDrift()) {
            ...
            for (StatusDriftResult.Evidence ev : f.evidence()) {
                appendStatusDriftEvidence(sb, ev);
            }
        }
        sb.append("\n");
    }

    private static void appendStatusDriftEvidence(StringBuilder sb, StatusDriftResult.Evidence ev) {
        sb.append("  - ")
                .append(ev.signal())
                .append(" [")
